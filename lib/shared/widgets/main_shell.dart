...
class MainShell extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ref.watch(themeProvider); // rebuild nav bar on every theme change
    return Scaffold(
...
class _AnimatedNavBarState extends State<_AnimatedNavBar>
  ...
  void initState() {
    ...
    _liftAnim = _iconCtrl.map((c) {
      return Tween<double>(begin: 0, end: _liftAmount).animate(
            ...
            return Stack(
              ...
              children: [
                ...
                AnimatedBuilder(
                  animation: _pillAnim,
                  builder: (_, __) {
                    final pillX = _pillAnim.value * tabWidth +
                        (tabWidth - _pillSize) / 2;
                    final pillTop =
